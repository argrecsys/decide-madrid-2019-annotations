package es.uam.irg.decidemadrid.nlp;
...
//                        freqs.put(t, 0);
//                    }
//                    freqs.put(t, 1 + freqs.get(t));
//                }
//            }
//
//            for (String t : freqs.keySet()) {
//                System.out.println(t + "\t" + freqs.get(t));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
